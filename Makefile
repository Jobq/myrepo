...
ACLOCAL = ${SHELL} /home/joachim/Desktop/vlc-2.0.8/autotools/missing --run aclocal-1.11
ALIASES =  cvlc rvlc qvlc
...
AR = ar
ARCH = i686 mmx sse sse2
AS = as
ASM = 
AUTOCONF = ${SHELL} /home/joachim/Desktop/vlc-2.0.8/autotools/missing --run autoconf
AUTOHEADER = ${SHELL} /home/joachim/Desktop/vlc-2.0.8/autotools/missing --run autoheader
AUTOMAKE = ${SHELL} /home/joachim/Desktop/vlc-2.0.8/autotools/missing --run automake-1.11
AVCODEC_CFLAGS =  
...
CFLAGS = -g -O2 -Wall -Wextra -Wsign-compare -Wundef -Wpointer-arith -Wbad-function-cast -Wwrite-strings -Wmissing-prototypes -Wvolatile-register-var -Werror-implicit-function-declaration -pipe -fvisibility=hidden  -ffast-math -funroll-loops -fomit-frame-pointer -mtune=pentium2
CFLAGS_access_avio =    
CFLAGS_access_dv = 
...
CFLAGS_caca =    
CFLAGS_cdda =   
CFLAGS_dbus =  -I/usr/include/dbus-1.0 -I/usr/lib/i386-linux-gnu/dbus-1.0/include  
CFLAGS_dc1394 = 
CFLAGS_deinterlace = 
...
CFLAGS_inhibit =  -I/usr/include/dbus-1.0 -I/usr/lib/i386-linux-gnu/dbus-1.0/include  
CFLAGS_jack = 
CFLAGS_kate = 
CFLAGS_libass =  -I/usr/include/freetype2 -I/usr/include/fribidi  
CFLAGS_libbluray = 
CFLAGS_libmpeg2 =  -I/usr/include/mpeg2dec   
CFLAGS_libvlccore =  -I/usr/include/dbus-1.0 -I/usr/lib/i386-linux-gnu/dbus-1.0/include  
CFLAGS_linsys_sdi = 
...
CFLAGS_postproc =    
CFLAGS_samplerate = 
CFLAGS_schroedinger =  -I/usr/include/orc-0.4 -I/usr/include/schroedinger-1.0   
...
CFLAGS_svg = 
CFLAGS_swscale =   
CFLAGS_telepathy =  -I/usr/include/dbus-1.0 -I/usr/lib/i386-linux-gnu/dbus-1.0/include  
CFLAGS_theora =    
CFLAGS_twolame =    
CFLAGS_udev = 
...
CFLAGS_zvbi = 
CONTRIB_DIR = 
COPYRIGHT_MESSAGE = Copyright © 1996-2013 VLC authors and VideoLAN
...
GCRYPT_CFLAGS = 
GCRYPT_LIBS = -L/lib/i386-linux-gnu -lgcrypt
...
LIBS_compressor = -lm 
LIBS_crystalhd = 
LIBS_dbus = -ldbus-1 -lpthread -lrt   -lm 
LIBS_dc1394 = 
...
LIBS_i420_rgb = -lm 
LIBS_i420_rgb_mmx = 
LIBS_inhibit = -ldbus-1 -lpthread -lrt   
LIBS_jack = 
LIBS_kate = -lm 
...
LIBS_libvlccore = -ldbus-1 -lpthread -lrt   -lrt -lpthread 
LIBS_linsys_sdi = 
LIBS_lirc = 
...
LIBS_sid = 
LIBS_skins2 =   -lSM -lICE -lXext     -lX11 -lfribidi   -lfreetype   ${top_builddir}/modules/access/zip/unzip/libunzip.la -lz -lm 
LIBS_spatializer = -lm 
...
LIBS_taglib = -ltag   -lz 
LIBS_telepathy = -ldbus-1 -lpthread -lrt   
...
MAINT = 
MAKEINFO = ${SHELL} /home/joachim/Desktop/vlc-2.0.8/autotools/missing --run makeinfo
MANIFEST_TOOL = :
MCE_CFLAGS = 
MCE_LIBS = 
...
SAMPLERATE_CFLAGS = 
SAMPLERATE_LIBS = 
SCHROEDINGER_CFLAGS = -I/usr/include/orc-0.4 -I/usr/include/schroedinger-1.0  
...
VERSION_EXTRA = 0
VERSION_MAJOR = 2
VERSION_MESSAGE = 2.0.8 Twoflower
VERSION_MINOR = 0
VERSION_REVISION = 8
VORBIS_CFLAGS =  
...
ZVBI_CFLAGS = 
ZVBI_LIBS = 
abs_builddir = /home/joachim/Desktop/vlc-2.0.8
abs_srcdir = /home/joachim/Desktop/vlc-2.0.8
abs_top_builddir = /home/joachim/Desktop/vlc-2.0.8
abs_top_srcdir = /home/joachim/Desktop/vlc-2.0.8
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/joachim/Desktop/vlc-2.0.8/autotools/install-sh
...
EXTRA_DIST = extras/package/win32/vlc.exe.manifest \
	...
	extras/package/win32/languages/croatian.nsh \
	...
	extras/package/macosx/Resources/mainwindow_dark/back-pressed_dark@2x.png \
	extras/package/macosx/Resources/mainwindow_dark/back_dark.png \
	extras/package/macosx/Resources/mainwindow_dark/back_dark@2x.png \
	...
	extras/package/macosx/Resources/mainwindow_dark/forward-pressed_dark@2x.png \
	extras/package/macosx/Resources/mainwindow_dark/forward_dark.png \
	extras/package/macosx/Resources/mainwindow_dark/forward_dark@2x.png \
...
dist_noinst_SCRIPTS = bootstrap make-alias
...
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/extras/package/macosx/package.mak $(srcdir)/extras/package/win32/package.mak $(srcdir)/extras/package/npapi.am $(am__configure_deps)
	@for dep in $?; do \
...
$(srcdir)/extras/package/macosx/package.mak $(srcdir)/extras/package/win32/package.mak $(srcdir)/extras/package/npapi.am:
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	extras/package/win32/languages/serbian.nsh \
	...
	extras/package/win32/languages/ukrainian.nsh \
	extras/package/win32/UAC/examples \
	extras/package/win32/UAC/examples/UAC_AllowLUA.nsi \
	extras/package/win32/UAC/examples/UAC_AdminOnly.nsi \
	extras/package/win32/UAC/examples/UAC_Uninstaller.nsi \
	extras/package/win32/UAC/examples/UAC.nsh \
	extras/package/win32/UAC/examples/UAC_GetUserShellFolderPath.nsi \
	extras/package/win32/UAC/examples/UAC_RealWorldFullyLoadedDualModeExample.nsi \
	extras/package/win32/UAC/History.txt \
	extras/package/win32/UAC/License.txt \
	extras/package/win32/UAC/nsisutil.h \
	extras/package/win32/UAC/resource.h \
	extras/package/win32/UAC/resource.rc \
