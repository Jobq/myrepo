...
/* Copyright string */
#define COPYRIGHT_MESSAGE "Copyright © 1996-2013 VLC authors and VideoLAN"
...
/* Define if libav* use planar audio formats */
#define HAVE_AVUTIL_PLANAR 1
...
#define PACKAGE_STRING "vlc 2.0.8"
...
#define VERSION_MESSAGE "2.0.8 Twoflower"

/* compiler */
#define VLC_COMPILER "gcc version 4.6.3 (Ubuntu/Linaro 4.6.3-1ubuntu5) "

/* user who ran configure */
#define VLC_COMPILE_BY "joachim"

/* host which ran configure */
#define VLC_COMPILE_HOST "joachim-vlc"
