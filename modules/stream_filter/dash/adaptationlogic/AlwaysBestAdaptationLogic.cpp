...
{
    cout << "ALWAYS BEST ADAPT LOGIC HERE" << endl;
...
Chunk* AlwaysBestAdaptationLogic::doTheThing() throw(EOFException)
{

    cout << "dothething ADAPT LOGIC HERE" << endl;
...
/*    for(size_t i = 0; i < this->schedule.size(); i++)
    ...
    return NULL;*/
    Chunk *chunk = new Chunk();
    chunk->setUrl(this->schedule.at(3)->getSourceUrl());
    return chunk;
}
